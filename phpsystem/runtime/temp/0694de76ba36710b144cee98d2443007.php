...
<script>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>申请id</td><td>申请的社团</td><td>申请时间</td><td>审核结果</td><td>操作</td></tr>
				    					<?php
				    						/*计算起始序号*/
				    					...
				    					if(is_array($shenqingRs) || $shenqingRs instanceof \think\Collection): $i = 0; $__LIST__ = $shenqingRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shenqing): $mod = ($i % 2 );++$i;?>
 										<tr>
 											...
 											<td>
 												...
 												<a href="#" onclick="shenqingDelete('<?php echo $shenqing['shenqingId']; ?>');" ><i class="fa fa-trash-o fa-fw"></i>退出社团</a>
 											</td> 
 										</tr>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="shenqingQueryForm" id="shenqingQueryForm" action="<?php echo url('Shenqing/user_frontlist'); ?>" class="mar_t15" method="post">
            <div class="form-group">
