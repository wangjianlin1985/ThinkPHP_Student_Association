...
<script>
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					if(is_array($postInfoRs) || $postInfoRs instanceof \think\Collection): $i = 0; $__LIST__ = $postInfoRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$postInfo): $mod = ($i % 2 );++$i;?>
 										<tr>
 											...
 											<td><?php echo $postInfo['userObjF']['name']; ?></td>
 											...
 											<td>
 												...
 												<a href="#" onclick="postInfoDelete('<?php echo $postInfo['postInfoId']; ?>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="postInfoQueryForm" id="postInfoQueryForm" action="<?php echo url('PostInfo/frontlist'); ?>" class="mar_t15" method="post">
			<div class="form-group">
