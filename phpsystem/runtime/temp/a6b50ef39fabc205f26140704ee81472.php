<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\xampp\htdocs\phpsystem\public/../application/back\view\postInfo\postInfo_query.html";i:1542887793;}*/ ?>
...
<div id="postInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="postInfoQueryForm" method="post">
			帖子标题：<input type="text" class="textbox" id="title" name="title" style="width:110px" />
	...
	<form id="postInfoEditForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="postInfo_postInfoId_edit" name="postInfo_postInfoId" style="width:200px" />
			</span>
		</div>
		<div>
			<span class="label">帖子标题:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="postInfo_title_edit" name="postInfo_title" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="postInfo_hitNum_edit" name="postInfo_hitNum" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="postInfo_userObj_user_name_edit" name="postInfo_userObj_user_name" style="width: auto"/>
			</span>
		</div>
		<div>
			<span class="label">发帖时间:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="postInfo_addTime_edit" name="postInfo_addTime" />
...
<script type="text/javascript" src="__PUBLIC__/backjs/postInfo/postInfo_manage.js"></script>
