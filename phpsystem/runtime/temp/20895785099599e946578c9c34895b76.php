<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\xampp\htdocs\phpsystem\public/../application/back\view\userInfo\userInfo_query.html";i:1542887791;}*/ ?>
	...
	<form id="userInfoEditForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_user_name_edit" name="userInfo_user_name" style="width:200px" />
			</span>
		</div>
		<div>
			<span class="label">登录密码:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_password_edit" name="userInfo_password" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_name_edit" name="userInfo_name" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_gender_edit" name="userInfo_gender" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_birthDate_edit" name="userInfo_birthDate" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_telephone_edit" name="userInfo_telephone" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_email_edit" name="userInfo_email" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_address_edit" name="userInfo_address" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="userInfo_regTime_edit" name="userInfo_regTime" />
...
<script type="text/javascript" src="__PUBLIC__/backjs/userInfo/userInfo_manage.js"></script>
