...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Shetuan/frontlist'); ?>">社团信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">社团id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['shetuanId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">社团名称:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['shetuanName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">社团图片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="__PUBLIC__/<?php echo $shetuan['shetuanPhoto']; ?>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所在院系专业:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['yxzyObjF']['yxzyName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">成立日期:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['bornDate']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">社团简介:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['shetuanDesc']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">负责人:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['fuzeren']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">联系电话:</div>
		<div class="col-md-10 col-xs-6"><?php echo $shetuan['telephone']; ?></div>
	</div>
	<div class="row bottom15">
		<div class="col-md-2 col-xs-4"></div>
		<div class="col-md-6 col-xs-6">
			<button onclick="shenqing();" class="btn btn-primary">申请入团</button>&nbsp;&nbsp;
...
function shenqing() {
    $.ajax({
        url : "<?php echo url('Shenqing/frontUserAdd'); ?>",
        type : "post",
        dataType: "json",
        data: {
            "shenqing_shetuanObj_shetuanId": <?php echo $shetuan['shetuanId']; ?>,
        },
